// Commit-time seeder for OSINT session 2026-06-18_0xsweep (KOL 0xSweep).
...
//   KolWallet has no natural unique key -> guarded by manual exists-check on (kolHandle,address,chain).
// NO migration (forensic columns already in prod via known drift).
// Usage: set -a; . ./.env.local; set +a; node src/scripts/seed/seed-osint-0xsweep-2026-06-18.mjs
import { PrismaClient, Prisma } from '@prisma/client'
import { readFileSync, existsSync } from 'node:fs'

const PLAN = 'exports/seed_plan_2026-06-18_0xsweep.json'
const REPORT = 'exports/seed_report_2026-06-18_0xsweep.json'
