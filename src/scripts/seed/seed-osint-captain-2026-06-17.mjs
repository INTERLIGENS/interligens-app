// Commit-time seeder for OSINT session 2026-06-17_captain_meme1 (KOL captain_meme1).
...
// Usage: set -a; . ./.env.local; set +a; node src/scripts/seed/seed-osint-captain-2026-06-17.mjs
import { PrismaClient, Prisma } from '@prisma/client'
import { readFileSync, existsSync } from 'node:fs'

const PLAN = 'exports/seed_plan_2026-06-17_captain_meme1.json'
const REPORT = 'exports/seed_report_2026-06-17_captain_meme1.json'
