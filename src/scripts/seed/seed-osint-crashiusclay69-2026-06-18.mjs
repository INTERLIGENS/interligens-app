// Commit-time seeder for OSINT session 2026-06-18_crashiusclay69 (KOL CrashiusClay69).
...
//   KolProfile by UNIQUE(handle) via upsert update:{} (no-clobber).
// This session has 0 wallets / 0 aliases (arrays empty in plan) — loops are no-ops.
// NO migration (forensic columns already in prod via known drift).
// Usage: set -a; . ./.env.local; set +a; node src/scripts/seed/seed-osint-crashiusclay69-2026-06-18.mjs
import { PrismaClient, Prisma } from '@prisma/client'
import { readFileSync, existsSync } from 'node:fs'

const PLAN = 'exports/seed_plan_2026-06-18_crashiusclay69.json'
const REPORT = 'exports/seed_report_2026-06-18_crashiusclay69.json'
