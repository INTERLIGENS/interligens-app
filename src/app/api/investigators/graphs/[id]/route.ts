...
// PUBLIC graphs are served via /api/investigators/intel (separate route).
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  // Validate visibility change: only PRIVATE ↔ TEAM_POOL is self-service.
...
// DELETE — owner only. Cascades with workspace anyway.
