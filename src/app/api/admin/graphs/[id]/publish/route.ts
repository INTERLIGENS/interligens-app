...
//
// PUBLIC promotion is gated to admin review because PUBLIC graphs are
// visible across all investigator workspaces — a review step prevents
// operators from exposing sensitive case intelligence by mistake.
