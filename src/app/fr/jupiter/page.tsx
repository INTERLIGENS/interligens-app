...
function scoreToBadge(score: number | undefined, verdict: string | undefined): BadgeConfig | null {
  ...
  if (score > 70) {
    return { label: "RISQUE ÉLEVÉ", color: "#FF3B5C", bg: "rgba(255,59,92,0.08)", border: "rgba(255,59,92,0.4)" };
  }
  if (score > 30) {
    return { label: "ATTENTION", color: "#FFB800", bg: "rgba(255,184,0,0.08)", border: "rgba(255,184,0,0.35)" };
  }
  return { label: "VÉRIFIÉ SÛR", color: "#00FF94", bg: "rgba(0,255,148,0.07)", border: "rgba(0,255,148,0.3)" };
}
...
export default function JupiterPage() {
  ...
  const isHighRisk = badge?.label === "RISQUE ÉLEVÉ";
      ...
      <main style={{ minHeight: "100vh", background: "#000000", color: "#FFFFFF" }}>
        <div style={{ maxWidth: 920, margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            >
              Échange Sécurisé · Propulsé par INTERLIGENS
            </div>
            <h1
              style={{
                fontSize: 44,
            ...
            >
              INTERLIGENS analyse chaque token avant votre échange.
            </p>
          </div>
            ...
            {isHighRisk && (
              ...
              >
                ...
                >
                  ...
                  >
                    Ignorer — continuer à mes risques
                  </button>
                </div>
              </div>
            )}
          ...
          {/* ── Signaux d'attention (non bloquants) ──────────────────── */}
          {badge?.label === "ATTENTION" && score?.signals && score.signals.length > 0 && (
            <div
              style={{
                marginTop: 16,
                padding: "12px 16px",
            ...
            >
              ...
              >
                Signaux suspects — vérifier avant signature
              </div>
          ...
          >
            Analyse basée sur les signaux. Ne constitue pas un conseil financier.
          </p>
        </div>
      </main>
    </>
