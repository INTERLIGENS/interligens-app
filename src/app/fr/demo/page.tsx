          ...
          <div className="grid lg:grid-cols-12 gap-8 animate-in zoom-in-95 duration-700 ease-out">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <div className="bg-[#0A0A0A] border border-zinc-800 rounded-2xl p-6">
                ...
                {showEvidence && (
                  <>
                    <TechnicalEvidence lang="fr" chain={result.chain === "ETH" ? "ethereum" : "solana"} show={true} provider_used={result.provider_used} spenders={result.spenders} unlimitedCount={result.unlimitedCount} freezeAuthority={result.freezeAuthority} mintAuthority={result.mintAuthority} />
