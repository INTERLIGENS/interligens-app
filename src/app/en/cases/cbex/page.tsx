...
export const metadata: Metadata = {
  title: "CBEX — The $12M Ponzi That Never Stopped · INTERLIGENS",
  description:
    "Platform Fraud casefile IL-PON-CBEX-001. An active Ponzi-network infrastructure on TRON and Ethereum — documented wallets, linked entities, and cash-out exchanges.",
  openGraph: {
    title: "CBEX — The $12M Ponzi That Never Stopped · INTERLIGENS",
    description:
      "Platform Fraud casefile IL-PON-CBEX-001. Active fraud infrastructure — documented critical risk.",
  },
};
...
export default async function CbexCasePageEN() {
  const data = await getCbex();
  if (!data) notFound();
  return <PlatformCasefileView data={data} locale="en" />;
}
