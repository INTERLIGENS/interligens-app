...
import { getTier, getTierOrUnknown, getTierOrUnknownColor, computeFinalVerdict } from "@/lib/risk/tier";
        ...
        <div className="relative">
          ...
          <div style={{ opacity: result && currentScanAddress === address.trim() ? 1 : 0, transition: "opacity 300ms ease-in", pointerEvents: result && currentScanAddress === address.trim() && !loading ? "auto" : "none" }}>
            {result && currentScanAddress === address.trim() && (() => {
                ...
                return (
                  <div style={{ border: "1px solid #6b728055", background: "#0A0A0A", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ fontSize: 13, color: "#9ca3af", lineHeight: 1.7 }}>
                      No risk score could be measured for this address. This is not a clean result: it means the data required to produce a verdict was unavailable. Absence of a score is not absence of risk.
                    </div>
                  </div>
                );
              }
              ...
              // interdite.
              const _sel = selectVerdictCopy(_fv.tier, "en", result.risk?.coverage?.sufficient);
            ...
            <div className="lg:col-span-5 bg-[#0A0A0A] border border-zinc-800 rounded-2xl p-8 flex flex-col items-center text-center relative overflow-hidden">
              <div className="absolute top-6 right-6">
                ...
                >
                  {_nonVerifie ? "UNVERIFIED" : finalTier}
                </span>
              </div>
              ...
              <div className="bg-[#080808] border border-zinc-800/80 rounded-xl p-4" style={{ borderTop: '2px solid #F85B0540' }}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    type="button"
                    disabled
                    title="PDF report unavailable — requires authorisation"
                ...
                <div className="mt-3">
                  ...
                  <CaseFileCTA id={address.trim() || null} lang="en" available={false} />
                </div>
