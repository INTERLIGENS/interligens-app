    ...
    <div style={{ minHeight: '100vh', background: '#000000', color: '#f9fafb', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginTop: 32, textAlign: 'center' }}>
          <a href={"/scan?addr=" + address} style={{ display: "inline-block", background: "#1e293b", border: "1px solid #374151", borderRadius: 8, color: "#94a3b8", padding: "10px 20px", fontSize: 12, fontWeight: 600, textDecoration: "none" }}>{isFr ? "Retour au scan" : "Back to scan"}</a>
        </div>
      </div>
    </div>
  )
