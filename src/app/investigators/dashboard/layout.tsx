...
export default async function InvestigatorsDashboardLayout({
  children,
}: {
    ...
    <>
      <nav style={BAR_STYLE}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <Link href="/investigators/dashboard" className="investigators-quick-link" style={{ ...QUICK_LINK, color: "#FF6B00" }}>
            Dashboard
          </Link>
