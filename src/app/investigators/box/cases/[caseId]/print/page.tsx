  ...
  return (
    ...
    >
      <style>{`
        ...
        th { background: #f5f5f5; font-size: 9px; text-transform: uppercase; letter-spacing: 0.08em; font-weight: 600; }
      ...
      >
        ...
        >
          Confidential — Investigator use only
        </div>
      </div>
      ...
      >
        <div>
          Generated by INTERLIGENS Investigators — {generatedAt}
        </div>
        <div>
          This report contains derived intelligence only. Raw files are never
          included.
        </div>
      </div>
