...
export const BOTIFY_DATA: PlainteInput = {
  ...
  preuvesCles: [
    { id: "D-001", statut: "A_CONFIRMER", nature: "Document interne BOTIFY complet (15 pages)", description: "Document interne BOTIFY complet (15 pages) : (1) Pitch deck officiel — KOLs 'On Board Already' : EduRio, PaoloG, DegnBen, MoonKing, 0xDale, James Bull, Brommy, Sibel, JammaPelson, AnonymousCFS, Cheatcoiner. (2) Tableau 40+ KOLs avec %, montants USD, wallets Solana, règles vesting. (3) F&F wallets BK + SAM avec adresses complètes. (4) Feuille dépenses avec TX Solscan vérifiables. (5) Équipe Botify — salaires hebdomadaires + wallets.", force: "HAUTE", note: "PIÈCE D'ORIENTATION — Hash SHA-256 : c29122cbda2bf90568259cdaf6b55b60152950a8773e30809574529959770feb. Document complet 15 pages : pitch deck + liste 40+ KOLs avec wallets et % allocation + F&F clusters BK (Illya/Mom/Dad/Carter/Jon/Azeem) et SAM (Dad/Nick/Simon/Rut/Chad/Ben/Evan/Mum) + feuille dépenses TX Solscan vérifiables (MEXC listing $90K, TikTok $150K, Gordon 55 SOL) + équipe avec salaires hebdomadaires." },
