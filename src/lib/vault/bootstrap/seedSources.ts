...
export const DEFAULT_SOURCES: SeedSourceDef[] = [
  ...
  // ── PR4 : 16 sources additionnelles ──────────────────────────────────────
  {
    name: "Chainalysis Reactor",
    handle: "chainalysis",
    sourceName: "Chainalysis Reactor",
    sourceType: "analytics",
    homepageUrl: "https://www.chainalysis.com",
    description: "Données de traçage et entités on-chain issues de Chainalysis Reactor.",
    defaultChain: null,
  ...
  },
  {
    ...
    sourceName: "Elliptic",
    sourceType: "analytics",
    homepageUrl: "https://www.elliptic.co",
    description: "Compliance et risk scoring blockchain par Elliptic.",
    defaultChain: null,
    defaultLabelType: "entity",
    defaultLabel: null,
    defaultVisibility: "internal_only",
  ...
  },
  {
    ...
    sourceName: "TRM Labs",
    sourceType: "analytics",
    homepageUrl: "https://www.trmlabs.com",
    description: "Intelligence blockchain et détection de fraude par TRM Labs.",
    defaultChain: null,
    defaultLabelType: "entity",
    defaultLabel: null,
    defaultVisibility: "internal_only",
  ...
  },
  {
    ...
    handle: "crystal",
    sourceName: "Crystal Blockchain",
    sourceType: "analytics",
    homepageUrl: "https://crystalblockchain.com",
    description: "Analyse de risque et traçage de fonds par Crystal Blockchain.",
    defaultChain: null,
    defaultLabelType: "entity",
    defaultLabel: null,
    defaultVisibility: "internal_only",
  ...
  {
    name: "FATF Virtual Assets",
    handle: "fatf",
    sourceName: "FATF Virtual Assets",
    sourceType: "regulatory",
    homepageUrl: "https://www.fatf-gafi.org",
    description: "Recommandations FATF sur les actifs virtuels et adresses à risque.",
    defaultChain: null,
    defaultLabelType: "sanctions",
    defaultLabel: "fatf_flagged",
    defaultVisibility: "public",
    license: "public_domain",
    tosRisk: "none",
    trusted: true,
  },
  {
    ...
    handle: "eu-sanctions",
    sourceName: "EU Sanctions List",
    sourceType: "regulatory",
    homepageUrl: "https://data.europa.eu/data/datasets/consolidated-list-of-persons-groups-and-entities-subject-to-eu-financial-sanctions",
    description: "Liste consolidée des sanctions financières de l'Union Européenne.",
    defaultChain: null,
    defaultLabelType: "sanctions",
    defaultLabel: "eu_sanctioned",
    defaultVisibility: "public",
    license: "public_domain",
    tosRisk: "none",
    trusted: true,
  },
  {
    ...
    sourceType: "regulatory",
    homepageUrl: "https://scsanctions.un.org",
    description: "Liste des sanctions du Conseil de Sécurité des Nations Unies.",
    defaultChain: null,
    defaultLabelType: "sanctions",
    defaultLabel: "un_sanctioned",
    defaultVisibility: "public",
    license: "public_domain",
    tosRisk: "none",
    trusted: true,
  },
  {
    ...
    handle: "fincen",
    sourceName: "FinCEN Advisories",
    sourceType: "regulatory",
    homepageUrl: "https://www.fincen.gov/resources/advisories",
    description: "Avis FinCEN sur les entités crypto à risque et blanchiment.",
    defaultChain: null,
    defaultLabelType: "sanctions",
    defaultLabel: "fincen_flagged",
    defaultVisibility: "public",
    license: "public_domain",
    tosRisk: "none",
    trusted: true,
  },
  {
    ...
    handle: "immunefi",
    sourceName: "Immunefi Bug Bounty",
    sourceType: "threat_intel",
    homepageUrl: "https://immunefi.com/bug-bounty",
    description: "Rapports de vulnérabilités et exploits publiés via Immunefi.",
    defaultChain: null,
    defaultLabelType: "hacker",
    defaultLabel: "whitehat_reported",
    defaultVisibility: "public",
    license: "public",
    tosRisk: "low",
    trusted: true,
  },
  {
    ...
    sourceName: "BlockSec",
    sourceType: "threat_intel",
    homepageUrl: "https://blocksec.com",
    description: "Analyses post-mortem et détections d'attaques on-chain par BlockSec.",
    defaultChain: null,
    defaultLabelType: "hacker",
    defaultLabel: "hack",
    defaultVisibility: "public",
  ...
  },
  {
    name: "Hypernative",
    handle: "hypernative",
    sourceName: "Hypernative",
    sourceType: "threat_intel",
    homepageUrl: "https://www.hypernative.io",
    description: "Détection préventive d'exploits et anomalies on-chain par Hypernative.",
    defaultChain: "evm",
    defaultLabelType: "attacker",
    defaultLabel: "hypernative_alert",
    defaultVisibility: "public",
    license: "public",
    tosRisk: "low",
    trusted: true,
  ...
  {
    name: "OpenSanctions",
    handle: "opensanctions",
    sourceName: "OpenSanctions",
    sourceType: "regulatory",
    homepageUrl: "https://www.opensanctions.org",
    description: "Base de données ouverte et consolidée de sanctions internationales.",
    defaultChain: null,
    defaultLabelType: "sanctions",
    defaultLabel: "opensanctions_match",
    defaultVisibility: "public",
    license: "cc0",
    tosRisk: "none",
    trusted: true,
  ...
  {
    name: "Dune Analytics Labels",
    handle: "dune",
    sourceName: "Dune Analytics Labels",
    sourceType: "analytics",
    homepageUrl: "https://dune.com",
    description: "Labels on-chain communautaires publiés via les dashboards Dune Analytics.",
    defaultChain: "evm",
    defaultLabelType: "entity",
    defaultLabel: null,
    defaultVisibility: "public",
  ...
  },
  {
    name: "Token Sniffer",
    handle: "tokensniffer",
    sourceName: "Token Sniffer",
    sourceType: "threat_intel",
    homepageUrl: "https://tokensniffer.com",
    description: "Détection automatique de rug pulls et honeypots par Token Sniffer.",
    defaultChain: "evm",
    defaultLabelType: "scam",
  ...
  },
  {
    ...
    sourceType: "threat_intel",
    homepageUrl: "https://honeypot.is",
    description: "Détecteur de honeypot tokens EVM — tokens non vendables.",
    defaultChain: "evm",
    defaultLabelType: "scam",
    defaultLabel: "honeypot",
    defaultVisibility: "public",
    license: "public",
    tosRisk: "low",
    trusted: true,
  },
  {
    ...
    sourceName: "AML Bot",
    sourceType: "analytics",
    homepageUrl: "https://amlbot.com",
    description: "Scoring AML et vérification d'adresses crypto par AML Bot.",
    defaultChain: null,
    defaultLabelType: "entity",
    defaultLabel: null,
    defaultVisibility: "internal_only",
