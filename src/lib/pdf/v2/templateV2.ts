...
export function renderHtmlV2(scan: any, lang: string): string {
  ...
  const retailHtml = '<div style="margin-top:18px;padding:14px 16px;background:#111;border-radius:12px;border:1px solid #222;">'
    ...
    + '<div style="background:#1a1a1a;border-radius:8px;padding:8px 10px;"><div style="font-size:8px;letter-spacing:2px;text-transform:uppercase;color:#666;margin-bottom:3px;">' + (isFr ? "Risque coordination" : "Coordination risk") + '</div><div style="font-size:11px;font-weight:700;color:#fff;">' + cabalScoreR + '</div><div style="font-size:10px;font-weight:800;color:' + cabalColR + ';margin-top:2px;">' + cabalTierR + '</div></div>'
