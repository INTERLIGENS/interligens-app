// ─────────────────────────────────────────────────────────────
// WATCHER V2 — Initial KOL Watchlist
// Generated 2026-04-04 · DO NOT DEPLOY — staging only
// ─────────────────────────────────────────────────────────────
...
export const handlesV2: WatchHandle[] = [
  ...
  { handle: 'CookerFlips',    category: 'pump_fun_caller',       priority: 'high', followerCount: 134_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'zachxbt_leak', notes: 'Wallet 8deJ9xe...XhU6 reported via public Solscan label — verify before ingesting' },
  ...
  { handle: 'Poe_Ether',      category: 'historic_calls',        priority: 'high', followerCount: 150_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'Regrets10x',     category: 'paid_multi_post',       priority: 'high', followerCount:  50_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'zachxbt_leak', notes: 'alias of lynk0x — already in DB' },
  ...
  { handle: 'lynk0x',         category: 'interligens_case',      priority: 'high', followerCount: 35_000, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'interligens_db', notes: 'also listed in medium list — deduplicated here as high' },
  ...
  { handle: 'TheCryptoLark',   category: 'community_callout',    priority: 'medium', followerCount: 400_000, chainFocus: 'SOL/multi', addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'Cryptozins',      category: 'community_callout',    priority: 'medium', followerCount:  80_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'Kmoney_69',       category: 'community_callout',    priority: 'medium', followerCount:  70_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'ApeMP5',          category: 'video_promo_undisclosed', priority: 'medium', followerCount: 60_000, chainFocus: 'SOL',     addedAt: '2026-04-04', source: 'zachxbt_leak' },
  ...
  { handle: 'CryptoSolanaCeo', category: 'community_callout',    priority: 'medium', followerCount:  55_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'DaoKwonDo',       category: 'zachxbt_leak',         priority: 'medium', followerCount:  50_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'zachxbt_leak' },
  ...
  { handle: '973Meech',        category: 'community_callout',    priority: 'medium', followerCount:  50_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'Renzofks',        category: 'community_callout',    priority: 'medium', followerCount:  40_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'boogiepnl',       category: 'community_callout',    priority: 'medium', followerCount:  35_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'FortisCartel',    category: 'community_callout',    priority: 'medium', followerCount:  30_000, chainFocus: 'SOL',       addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: 'JamesBull',       category: 'interligens_case',     priority: 'medium', followerCount: 0, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'interligens_db' },
  ...
  { handle: 'Sibel',           category: 'interligens_case',     priority: 'medium', followerCount: 0, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'interligens_db' },
  { handle: 'MoonKing',        category: 'interligens_case',     priority: 'medium', followerCount: 0, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'interligens_db' },
  ...
  { handle: 'Regrets10x',     category: 'interligens_case',     priority: 'medium', followerCount: 50_000, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'interligens_db', notes: 'also in high list via zachxbt_leak — dual-sourced' },
  ...
  { handle: 'arrogantfrfr',    category: 'community_callout',    priority: 'low', followerCount: 40_000,  chainFocus: 'SOL', addedAt: '2026-04-04', source: 'community_callout' },
  ...
  { handle: '0xVonGogh',       category: 'community_callout',    priority: 'low', followerCount: 100_000, chainFocus: 'SOL', addedAt: '2026-04-04', source: 'community_callout', notes: 'duplicate — also listed as medium' },
